/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: 681019d6ceca72755d5f12f456f3c9cc)
// Runtime types generated with workerd@1.20260722.1 2026-07-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
  OUTBOX_TARGET_URL: "https://admin-staging.shapewebs.com/api/jobs/outbox";
  SHAPEWEBS_ENVIRONMENT: "staging";
  CHECKLY_HEARTBEAT_URL: string;
  OUTBOX_CRON_SECRET: string;
  VERCEL_AUTOMATION_BYPASS: string;
}
