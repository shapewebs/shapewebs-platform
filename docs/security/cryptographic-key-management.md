...
| `ADMIN_AUTH_EMAIL_ENCRYPTION_SECRET`          | Encrypt employee verification and reset tokens awaiting delivery       | Admin/auth-email-worker encrypted environment only                                                 | suspected exposure, outbox redesign, environment retirement or annual exercise                     |
