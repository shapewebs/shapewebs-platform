...
prohibited. The TOTP use of HMAC-SHA-1 is not a collision-resistance use and is
permitted only for RFC 6238 interoperability.
...
| `REVALIDATION_WEBHOOK_SECRET`                 | Authenticate admin-to-public revalidation POST                         | Admin and web encrypted environments only                                       | exposure, sender/receiver rebuild or annual exercise                                               |
