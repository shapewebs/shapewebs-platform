...
export async function getPortalRegistrationContext(): Promise<CustomerRegistrationContext | null> {
...
export async function getPortalRegistrationContextFromRequest(
  request: Request,
): Promise<CustomerRegistrationContext | null> {
...
export async function createPortalRegistrationCookies(input: {
  email: string;
  name: string;
...
export function clearPortalRegistrationCookies(): string[] {
  const production = isProduction();
  return [
